    ...
    <div class="content">
        ...
        <div class="inner-content">
            <div class="card-wrapper">
                ...
                @include('backoffice.components.card',[
                    'title' => 'Total Pemain Aktif',
                    'subtitle' => '104',
                    'img' => asset('assets/card-aktif.svg')
                    ])
                @include('backoffice.components.card',[
                    'title' => 'Total Pemain Tidak Aktif',
                    'subtitle' => '104',
                    'img' => asset('assets/card-tidakaktif.svg')
                    ])
            </div>
            <div class="white-card">
                <h4>Informasi Team</h4>
                <hr>           
                <div class="side-garuda">
                    <div class="logo-garuda">
                        <img src="{{asset('assets/garuda-logo.svg')}}" alt="">
                    </div>
                    <div class="card-side-inner">
                        <div class="manager">
                            <div class="manager-inner">
                                <h4>Nama Team</h4>
                                <span>Timnas Indonesia</span>
                            </div>
                            <div class="manager-inner">
                                <h4>Manager / Pelatih</h4>
                                <span>Shin Tae-yong</span>
                            </div>
                        </div>
                        <div class="manager-inner">
                            <h4>Regional</h4>
                        ...
                        <div class="manager-inner">
                            <h4>Keterangan</h4>
                            <span>loreLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="white-card">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="participant-tab" data-bs-toggle="tab" data-bs-target="#daftarPemain" type="button" role="tab" aria-controls="daftarPemain" aria-selected="false">
                        Daftar Pemain
                        </button>
                    </li>
                </ul>
                ...
                <!-- Tab 1: Daftar Match -->
                    <div style=""class="tab-pane fade show active" id="daftarMatch" role="tabpanel" aria-labelledby="match-tab">
                        <!-- Tabel Match -->
                        ...
                        <table class="table" id="jadwalTable">
                            ...
                            <tr>
                                ...
                                <td class="gmbr">
                                    ...
                                    vs 
                                    Bahrain <img src="{{asset('assets/bahrain-small.svg')}}" alt="logo" width="24"></div>
                    ...
                    <div class="tab-pane fade" id="daftarPemain" role="tabpanel" aria-labelledby="participant-tab" style="cursor: pointer;">
                        <div class="table-responsive">
                            <table id="pemainTable" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Nama Pemain</th>
                                        <th>No. Punggung</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="player-info">
                                                <img src="{{asset('assets/martenpaess.svg')}}">
                                                Maarten Paes
                                            </div>
                                        </td>
                                        <td>01</td>
